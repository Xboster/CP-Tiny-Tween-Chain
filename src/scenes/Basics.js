class Basics extends Phaser.Scene {
    ...
    create() {
        ...
        this.instructionText = this.add
            .bitmapText(centerX, centerY, "gem_font", "", 24)
            .setOrigin(0.5);
        ...
        let basicTween = this.tweens.add({
            ...
            onRepeat: () => {
                this.instructionText.text = "Lets repeat the tween";
            },
            onComplete: () => {
        ...
        document.getElementById("info").innerHTML =
            "<strong>Basics.js</strong><br>R: Restart current scene";
    }
